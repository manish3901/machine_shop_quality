...
def rejection_form():
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            # Update rejection PCS to match sum of defects if needed
        ...
        if rejection.production_entry_id:
            ...
            if prod:
                ...
                prod_data = {
                    ...
                    'rework_qty': prod.rework_qty or 0,
                    'total_ok': prod.total_ok_quantity,
                    'total_rework_qty': prod.rework_qty or 0,
