...
def ensure_incremental_machine_shop_schema():
    ...
    ddl_statements = [
        ...
        """,
        """
        CREATE TABLE IF NOT EXISTS ms_quality_access (
            user_id INTEGER PRIMARY KEY,
            can_rejection_form BOOLEAN DEFAULT FALSE,
            can_rejection_records BOOLEAN DEFAULT FALSE,
...
def create_app(config_name='development'):
    ...
    def inject_helpers():
        from utils.auth import _has_quality_access
        return {
            'now': datetime.now(timezone.utc),
            'has_quality_access': _has_quality_access
        }
